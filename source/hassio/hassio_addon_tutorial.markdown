...
![Screenshot of Windows Explorer showing a folder on the Hass.io server](/images/hassio/tutorial/samba.png)
...
![Screenshot of Putty connected to Hass.io](/images/hassio/tutorial/ssh.png)
...
![Screenshot of the Hass.io main panel](/images/hassio/screenshots/main_panel_addon_store.png)

 - On the top right click the refresh button
 - You should now see a new card called "Local" that lists your add-on!

![Screenshot of the local repository card](/images/hassio/screenshots/local_repository.png)
...
![Screenshot of the add-on logs](/images/hassio/tutorial/addon_hello_world_logs.png)
...
![Screenshot of the file index served by the add-on](/images/hassio/tutorial/python3-http-server.png)
